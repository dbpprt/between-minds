...
Beim Aufruf dieser statischen Website koennen durch den jeweiligen Hosting-Anbieter technisch notwendige Daten verarbeitet werden, zum Beispiel IP-Adresse, Datum und Uhrzeit des Zugriffs, aufgerufene Seite, uebertragene Datenmenge, Browsertyp und Betriebssystem.

Der konkrete Hosting-Anbieter wird auf dieser Website derzeit nicht benannt.  
Rechtsgrundlage: Artikel 6 Absatz 1 Buchstabe f DSGVO

## 3. Server-Logfiles

Die Verarbeitung technischer Server-Logfiles dient der Stabilitaet und Sicherheit der Website. Umfang und Speicherdauer haengen vom eingesetzten Hosting-Anbieter ab.
...
Falls spaeter Analyse-Tools, Newsletter-Dienste, eingebettete Medien, Social-Media-Einbindungen, ein eigenes Kontaktformular oder externe Schriftarten eingebunden werden, muss diese Datenschutzerklaerung entsprechend erweitert werden.

## 6. Ihre Rechte

Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen das Recht auf Auskunft, Berichtigung, Loeschung, Einschraenkung der Verarbeitung, Datenuebertragbarkeit sowie Widerspruch gegen die Verarbeitung Ihrer personenbezogenen Daten.

Sofern Sie der Ansicht sind, dass die Verarbeitung Ihrer Daten gegen Datenschutzrecht verstoesst, haben Sie zudem das Recht, sich bei einer Aufsichtsbehoerde zu beschweren.
